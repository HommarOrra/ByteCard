...
try:
    ...
    insert_data_cartoes_query = """
        ...
        VALUES
        (1, '8888 2222 3333 4444', '564', 9999.00, '2023-08-26', 'João Baptista', 'ATIVO'),
        (2, '7777 2222 3333 4444', '564', 6750.00, '2022-10-08', 'Luiza Zago', 'CANCELADO'),
        (3, '5555 6666 3333 4444', '014', 22500.00, '2025-10-14', 'Alfredo da Rocha Viana Filho', 'ATIVO'),
        (4, '5555 2222 3333 4444', '312', 5000.00, '2024-10-16', 'Antonio Carlos Jobim', 'ATIVO'),
