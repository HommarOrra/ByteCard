...
### Teste pesquisa cartão existente

cartao_inexistente = use_cases.pesquisa_cartao_por_id(1000)

print(f'Cartão existente: {cartao_existente}')
print(f'Gráfico sem rótuloCartão existente: {cartao_inexistente}')

### Teste cadastra cartão
...
### Teste cadastra compras no cartão
...
### Teste do relatório agrupando os gastos do cartão por categoria
